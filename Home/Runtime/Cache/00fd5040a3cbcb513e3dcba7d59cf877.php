    ...
    <div class="container">    
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
                <div class="list_box">
                  <h2 class="left_h2">404错误页面</h2>

                <h1 style=" clear:both; text-align: center; line-height: 60px;padding-top:30px;">404错误：您请求的页面不存在或已被删除</h1>
                <ul class="ul_sitemap">
                  ...
                  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if($vo["level"] == 2): ?>class="small_li2_sitemap"<?php elseif($vo["level"] == 1): ?>class="small_li_sitemap"<?php endif; ?>>|-<?php echo ($vo["html"]); ?>
                          <a href="<?php echo W('Listhref',array('url'=>$vo['url'],'id'=>$vo['id'],'link'=>$vo['link']));?>" target="_blank"><?php echo ($vo["name"]); ?></a>  
