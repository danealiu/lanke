...
class PhotoAction extends CommonAction{
	public function index(){
		...
		$this->show=$page->show();
		$this->photo=$db->field('id,pid,name,sort,thumb')->order('sort asc,id desc')->limit($page->firstRow.','.$page->listRows)->select();
	...
	public function mod(){
		...
		$photolist=M('Photo')->field('id,pid,sort,name,url,title,keywords,description,thumb,photo,contents')->find($this->_get('id','intval'));
