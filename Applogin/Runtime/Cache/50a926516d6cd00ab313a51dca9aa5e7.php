  ...
  <div id="frames" style="width:198px;height:600px;overflow:hidden;"> 
    ...
    <div class="text">
      <ul>
        ...
        <li><a href="<?php echo U('Feedback/index');?>" target="main">留言管理</a></li>
        <li><a href="<?php echo U('inquiry/index');?>" target="main">订单管理</a></li>
      </ul>
    </div>
    </span> 
	<span class="link">
    ...
    <div class="text">
      <ul>
        <li><a href="<?php echo U('Link/add');?>" target="main">添加链接</a></li>
        <li><a href="<?php echo U('Link/index');?>" target="main">链接列表</a></li>
      </ul>
    </div>
    </span> 
	<span class="link">
